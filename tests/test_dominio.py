...
from dominio import (contato_telefone, resumo_notas, resumo_voltaria, expressao_busca, horario_local, normalizar_nota, preparar_busca,
...
class TestDominio(unittest.TestCase):
    ...
    def test_resumo_voltaria_conta_sim_e_usa_a_mais_recente(self):
        self.assertEqual(resumo_voltaria([3, None, 5, 4, 0]),
                         {"sim": 2, "respondidas": 4, "ultima": "Talvez"})
        self.assertIsNone(resumo_voltaria([None, None]))
        self.assertEqual(resumo_voltaria([0])["sim"], 0)
